...
router.post('/change-password', (0, auth_1.default)(user_1.USER_ROLES.AUDIO_ADMIN, user_1.USER_ROLES.BLOG_ADMIN, user_1.USER_ROLES.DOCTOR_ADMIN, user_1.USER_ROLES.USER, user_1.USER_ROLES.SUPER_ADMIN), (0, validateRequest_1.default)(auth_validation_1.AuthValidation.createChangePasswordZodSchema), auth_controller_1.AuthController.changePassword);
router.post('/resend-otp', auth_controller_1.AuthController.resendVerificationEmail);
router.delete('/delete-account', (0, auth_1.default)(user_1.USER_ROLES.AUDIO_ADMIN, user_1.USER_ROLES.SUPER_ADMIN), auth_controller_1.AuthController.deleteUser);
