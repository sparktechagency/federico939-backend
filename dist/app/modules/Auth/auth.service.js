...
const loginUserFromDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // check user status
    if (isExistUser.status === user_constant_1.STATUS.INACTIVE) {
        throw new AppError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'You don’t have permission to access this content. It looks like your account has been deactivated.');
    }
...
const verifyEmailToDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (date > ((_b = isExistUser.authentication) === null || _b === void 0 ? void 0 : _b.expireAt)) {
        throw new AppError_1.default(http_status_1.default.BAD_REQUEST, 'Otp already expired, Please try again');
    }
    let message;
    let data;
    if (!isExistUser.verified) {
...
const resetPasswordToDB = (token, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!((_c = isExistUser === null || isExistUser === void 0 ? void 0 : isExistUser.authentication) === null || _c === void 0 ? void 0 : _c.isResetPassword)) {
...
const changePasswordToDB = (user, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (newPassword !== confirmPassword) {
        throw new AppError_1.default(http_status_1.default.BAD_REQUEST, "Password and Confirm password doesn't matched");
    }
    // hash password
    const hashPassword = yield bcrypt_1.default.hash(newPassword, Number(config_1.default.bcrypt_salt_rounds));
    const updateData = {
