...
exports.socialMediaHTML = exports.resetLinkHTML = exports.resetLinkSubject = exports.OTPmailBody = exports.OTPmailSubject = void 0;
exports.OTPmailSubject = 'This Is Your OTP Code';
const OTPmailBody = (value) => {
...
exports.OTPmailBody = OTPmailBody;
exports.resetLinkSubject = 'Reset your password within ten mins!';
const resetLinkHTML = (resetUILink, name) => {
    const htmlBody = `
...
exports.resetLinkHTML = resetLinkHTML;
exports.socialMediaHTML = `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
